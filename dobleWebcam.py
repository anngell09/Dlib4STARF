#ABRE DOS VENTANAS Y HACE UN DESORODEN AL CAPTURAR FRAME POR FRAME
...
while True:
    ...
    for cara in caras:
        ...
        # Capturar el frame dentro del rectángulo
        frame_cara = frame[y:y+h, x:x+w]

        # Puedes hacer lo que quieras con el frame_cara, como guardar en disco o procesar más

        # Mostrar el frame resultante
        cv2.imshow('Frame de la Cara', frame_cara)
